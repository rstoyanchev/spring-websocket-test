...
public class ChatAnnotatedEndpoint {
	...
	private static final Set<ChatAnnotatedEndpoint> connections = new CopyOnWriteArraySet<ChatAnnotatedEndpoint>();

	private final String nickname;
	private Session session;

	public ChatAnnotatedEndpoint() {
	...
	private static void broadcast(String msg) {
		for (ChatAnnotatedEndpoint client : connections) {
			try {
